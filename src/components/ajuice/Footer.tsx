          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="text-gray-400 hover:text-sky-400 transition-colors text-sm">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Juice Fruit', 'Juice Vegetable'].map((cat) => (
                <li key={cat}>
                  <a href="#products" className="text-gray-400 hover:text-sky-400 transition-colors text-sm">
                    {cat}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+6285520913524" className="text-gray-400 hover:text-sky-400 transition-colors text-sm">
                  +62 855-2091-3524
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-sky-400 shrink-0 mt-0.5" />
                <a href="https://wa.me/6285520913524" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-sky-400 transition-colors text-sm">
                  WhatsApp
                </a>
              </li>
            </ul>
